...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <div className=" font-[Lufga-Regular-2] text-white flex flex-wrap bg-[#001eee] items-center justify-between px-6 sm:px-52 py-20 sm:mx-10">
        <div className="flex flex-col">
          <p className="pb-4">Get in touch </p>
          <p className="text-[2.3rem] font-[Lufga-Bold-2]">Contact Numbers</p>
        </div>
      ...
      <div className=" text-black font-[Lufga-Regular-2] flex flex-col sm:flex-row items-start sm:items-center justify-start sm:justify-between mx-6 sm:px-60 py-10 ">
        <div className="flex flex-col sm:mr-20">
          <p className="pb-4">Our locations </p>
          <p className="text-[2.3rem] font-[Lufga-Bold-2]">Visit our offices</p>
          <p>Find us at these locations.</p>
        </div>
        <div className="flex flex-col">
          <p className="font-[Lufga-Bold-2] text-[1.2rem] pt-2 sm:text-[1.5rem]">
            New York (HQ)
          </p>
          <p>
            1740 Broadway 15th Floor <br /> New York, NY 10019
          </p>
          <p className="font-[Lufga-Bold-2] pt-2 text-[1.2rem] sm:text-[1.5rem]">
            INDIA
          </p>
          <p>
            1385/3, 3rd Floor, 4th Cross, Tulasi Theather <br /> Road,
        ...
        <div className="flex flex-col">
          ...
          <p>
            60 Atlantic Ave Suite 200 <br /> Toronto, ON M6K 1X9
          </p>
          <p className="font-[Lufga-Bold-2] pt-2 text-[1.2rem] sm:text-[1.5rem]">
            Dubai
          </p>
          <p>
            Technohub 1, DTEC Dubai <br /> Silicon Oasis Dubai
          </p>
        </div>
      </div>
    </>
