...
const MultiCloud = () => {
  return (
    <>
      ...
      <div className="flex items-center justify-center mx-10 rounded-2xl">
        <img
          className="w-[90vw] sm:pb-4"
      ...
      <div className="flex flex-wrap items-center sm:border-t-2 border-[##595959] mx-10 justify-between py-2 sm:py-20 md:px-20">
        <div className="font-[Lufga-ExtraBold-2] text-[2.3rem] text-black sm:px-6 w-full md:w-1/2 flex flex-wrap">
          <p>
