...
const DevOps = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-7 place-items-center mx-10 gap-2 rounded-lg pb-6 sm:pb-20">
        ...
        <div className="col-span-1 place-self-stretch">
          <img
            className="rounded-lg"
        ...
        <div className="col-span-1 place-self-stretch sm:-translate-x-40">
          <img
            className="rounded-lg"
